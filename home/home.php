            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active position-relative">
                    ...
                    <div class="carousel-caption position-absoulute">
                        <h1>Discover Surabaya's Culinary Delights</h1>
                        <p style="font-size: 20px;">Explore the best food spots in the city</p>
                    </div>
                ...
                <div class="carousel-item position-relative">
                    ...
                    <div class="carousel-caption position-absoulute">
                        <h1>Your Guide to Surabaya's Food Hubs</h1>
                        <p style="font-size: 20px;">Find and explore local eateries</p>
                    </div>
                    <div class="gradient-main1"></div>
                </div>
                <div class="carousel-item position-relative">
                    ...
                    <div class="carousel-caption position-absoulute">
                        <h1>Taste Surabaya's Best</h1>
                        <p style="font-size: 20px;">Browse and discover the finest food stalls and culinary centers in Surabaya.</p>
                    </div>
                    <div class="gradient-main1"></div>
                </div>
            </div>
